<template>
  <CommonAppHeader />
  <main class="about-page selection:bg-primary-yellow selection:text-custom-dark">
    <section class="hero-shell">
      <div class="hero-grid max-canvas">
        <div class="hero-copy">
          <span class="hero-badge">{{ t('about.heroBadge') }}</span>
          <h1 class="hero-title">{{ t('about.heroTitle') }}</h1>
          <p class="hero-lead">{{ t('about.heroLead') }}</p>

          <div class="hero-actions">
            <NuxtLink to="/user/products" class="hero-button hero-button-primary">
              {{ t('home.exploreProducts') }}
            </NuxtLink>
            <NuxtLink to="/contacts" class="hero-button hero-button-secondary">
              {{ t('common.contacts') }}
            </NuxtLink>
          </div>
          ...
          <div class="hero-stats">
            <div class="stat-card">
              <span>{{ t('about.missions.directConnection.title') }}</span>
            </div>
            <div class="stat-card">
              <span>{{ t('about.challenge.title') }}</span>
            </div>
            <div class="stat-card">
              <span>{{ t('about.solution.title') }}</span>
            </div>
          </div>
        </div>
        ...
        <div class="hero-visual">
          <div class="hero-image-card">
            ...
            <div class="hero-image-overlay">
              <span>{{ t('about.team.subtitle') }}</span>
              <strong>{{ t('about.heroBadge') }}</strong>
            </div>
          </div>

          <div class="hero-note-card">
            <div class="note-chip">FarmLink</div>
    ...
    <section class="content-shell">
      <div class="max-canvas section-stack">
        <div class="section-heading">
          <p class="section-kicker">{{ t('about.missions.directConnection.title') }}</p>
          <h2>{{ t('about.team.title') }}</h2>
        </div>

        <div class="mission-grid">
          <article v-for="mission in missions" :key="mission.title" class="mission-card">
            <div class="mission-icon-wrap">
              <div class="mission-icon" v-html="mission.svg"></div>
            </div>
            <h3>{{ mission.title }}</h3>
    ...
    <section class="content-shell content-shell-soft">
      <div class="max-canvas section-stack">
        <div class="section-heading section-heading-wide">
          <p class="section-kicker">{{ t('about.challenge.label') }}</p>
          <h2>{{ t('about.challenge.title') }}</h2>
          <p class="section-copy">{{ t('about.challenge.description') }}</p>
        </div>

        <div class="insight-grid">
          <article class="insight-card insight-card-muted">
            <h3>{{ t('about.challenge.label') }}</h3>
            <div class="insight-list">
              <div v-for="item in challengeItems" :key="item" class="insight-list-item">
          ...
          <article class="insight-card insight-card-accent">
            ...
            <div class="solution-grid">
              <div class="solution-pill">
                <strong>{{ t('about.solution.cards.empowered.title') }}</strong>
                <span>{{ t('about.solution.cards.empowered.subtitle') }}</span>
              </div>
              <div class="solution-pill">
                <strong>{{ t('about.solution.cards.direct.title') }}</strong>
                <span>{{ t('about.solution.cards.direct.subtitle') }}</span>
              </div>
            </div>
          </article>
        </div>
...
const missions = computed(() => [
  {
    title: t('about.missions.directConnection.title'),
    description: t('about.missions.directConnection.description'),
  ...
  {
    title: t('about.missions.transparency.title'),
    description: t('about.missions.transparency.description'),
  ...
  {
    title: t('about.missions.fairPricing.title'),
    description: t('about.missions.fairPricing.description'),
...
const challengeItems = computed(() => [
  t('about.challenge.items.opaquePricing'),
  t('about.challenge.items.inefficientLogistics'),
  t('about.challenge.items.producerInsecurity')
])
...
.about-page {
  min-height: 100vh;
  background:
    radial-gradient(circle at top left, rgba(239, 207, 79, 0.2), transparent 28%),
    radial-gradient(circle at top right, rgba(106, 168, 79, 0.16), transparent 24%),
    linear-gradient(180deg, #fffdf6 0%, #f8f1df 100%);
  color: #132a13;
}
