<template>
  <footer class="w-full bg-cream border-t border-black/5">
      ...
      <div class="flex flex-col md:flex-row gap-10 lg:gap-[93px] mt-12 md:mt-0">
        ...
        <div class="flex flex-col gap-2 min-w-[150px]">
          ...
          <ul class="flex flex-col gap-2 footer-text">
            ...
            <li>
              <a class="hover:underline font-bold" href="tel:+855999999999">+855 99-999-999</a>
            </li>
          </ul>
        </div>
        ...
        <div class="flex flex-col gap-2 min-w-[150px]">
          ...
          <ul class="flex flex-col gap-2 footer-text">
            ...
            <li><NuxtLink class="hover:underline" to="/user/checkout/cart">Cart</NuxtLink></li>
        ...
        <div class="flex flex-col gap-2 min-w-[150px]">
          ...
          <ul class="flex flex-col gap-2 footer-text">
            <li><NuxtLink class="hover:underline" to="/user/about">Privacy policy</NuxtLink></li>
            <li><NuxtLink class="hover:underline" to="/user/about">Term of Use</NuxtLink></li>
            <li><NuxtLink class="hover:underline" to="/user/about#faq">FAQ</NuxtLink></li>
            <li><NuxtLink class="hover:underline" to="/user/contacts">Contact</NuxtLink></li>
          </ul>
        </div>
    ...
    <div class="w-full py-6 border-t-2 border-black/10 text-center">
      <p class="footer-text opacity-60 font-bold">© 2026 FarmLink. All rights reserved.</p>
    </div>
  </footer>
</template>
