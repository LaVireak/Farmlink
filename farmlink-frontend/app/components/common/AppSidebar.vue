	...
	<aside class="w-full md:w-[280px] shrink-0">
		<div class="bg-surface-container-lowest dark:bg-surface-container rounded-2xl border border-outline-variant p-5 sm:p-6 shadow-sm">
			<div class="flex items-center gap-3 mb-5">
				...
				/>
				<div>
					<h3 class="font-[Manrope,sans-serif] text-2xl leading-none font-extrabold text-on-surface">Sophal Saman</h3>
					<p class="text-sm text-on-surface-variant font-medium mt-1">Premium Member</p>
				</div>
			</div>
			<nav class="space-y-2">
				<NuxtLink
